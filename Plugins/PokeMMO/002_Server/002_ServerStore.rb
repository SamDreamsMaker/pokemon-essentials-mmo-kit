...
module PokeMMO
  module ServerStore
    ...
    def self.ensure_dir
      ...
      PokeMMO.log("store: mkdir failed: #{e.class}: #{e.message}")
    end
    ...
    def self.load_state(account_id)
      ...
      PokeMMO.log("store: load failed for #{account_id}: #{e.class}: #{e.message}")
      nil
    end
    ...
    def self.save_state(account_id, hash)
      ...
      PokeMMO.log("store: save failed for #{account_id}: #{e.class}: #{e.message}")
      false
    end
  end
end
